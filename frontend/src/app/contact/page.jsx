...
const page = () => {
  return (
    <>
    <section className="bg-white p-10 md:p-20 lg:mt-[-1rem]  lg:py-[120px] overflow-hidden relative z-10">
            ...
            <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
              <form>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full p-3 text-white transition border rounded border-primary bg-[#533aa7] hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
