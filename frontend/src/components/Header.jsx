...
const Header = () => {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <Link href={"/categories"} className="inline-flex items-center bg-[#533aa7] border-0 py-1 px-3 focus:outline-none hover:opacity-95 rounded text-white mt-4 md:mt-0">Categories
